...
public class RunMe {
	...
	public void start() {
		...
		String CONSUMER_KEY = "arNb6DNI26EmIbKjWQoH5g";
		String CONSUMER_SECRET = "wFj7FEE2pXCztmHs775xVi-B01Q";
		String TOKEN = "E2r5yBd7Vhpzl_Ol68nPreOZyr2-quJs";
		String TOKEN_SECRET = "iwm3CXAgRWvLe8djkoeAByvM7w4";
		...
		request.addQuerystringParameter("term", "McDonalds");
//		request.addQuerystringParameter("location", "Austin");
